...
def make_boundary(sim_name):
   ...
   # Which Parameters to fit
    if sim_name == '1':
        ...
        what_to_fit = ['beta_enc', 'beta_rec', 'beta_cue', 'beta_rec_post', 'beta_distract', 'gamma_fc', 'gamma_cf', 's_fc', 's_cf', 'phi_s', 'phi_d', 'kappa', 'lamb', 'eta', 'omega', 'alpha', 'c_thresh', 'c_thresh_itm', 'c_thresh_ass']
        # simulation specific boundary
        lb_dict.update(beta_enc = 0.4, 
                beta_rec = 0, 
                beta_cue = 0.4,
                beta_distract = 0,
                beta_rec_post = 0.2,

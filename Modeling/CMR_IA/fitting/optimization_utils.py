...
def make_boundary(sim_name):
   ...
   # Which Parameters to fit
    if sim_name == 'David':
        ...
        what_to_fit = ['beta_enc', 'beta_rec', 'beta_cue', 'beta_distract', 'gamma_fc', 'gamma_cf', 's_fc', 's_cf', 'phi_s', 'phi_d', 'kappa', 'lamb', 'eta', 'omega', 'alpha', 'c_thresh', 'c_thresh_itm', 'c_thresh_ass', 'd_ass']
